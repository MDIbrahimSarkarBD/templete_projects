...
<html lang="en">
  ...
  <body class="bg-info">
      ...
      <div class="row">
        ...
        <div class="col-md-6 bg-primary shadow p-4">
          <div class="mb-3">
            ...
            <input type="text" name="fullname" placeholder="for example: John Smith" class="form-control" required>
          </div>
          <div class="mb-3">
            <label>Profession</label>
            <input type="text" name="profession" placeholder="for example: Teacher/Fresh Graduate" class="form-control" required>
          </div>
          <div class="mb-3">
            <label>Picture</label>
          ...
          <div class="mb-3">
            <label>Conatct</label>
            <input type="text" name="address" placeholder="for example: City New York, USA" class="form-control">
            <input type="email" name="email" placeholder="for example: abc@gmail.com" class="form-control">
            <input type="text" name="mobile" placeholder="for example: +111222333" class="form-control">
          </div>
          <div class="mb-3">
        ...
        <div class="col-md-6 bg-primary shadow p-4">
          ...
          <div class="mb-3">
            <input type="submit" name="btn" class="btn btn-dark" value="Generate CV" name="cv_add">
             <!-- // cv_show start tag--- -->
                <div id="display_cv">
    ...
    <script>
      // id for user cv submit
      var cv_submit =  document.getElementById('cv_submit');
      var display_cv =  document.getElementById('display_cv');
      
      if(cv_submit){
        
       
        cv_submit.addEventListener('click', function (){
          
           const ajax = new XMLHttpRequest();
           var url = "query/cv.php";
           var params = "action=submit_cv";
          ...
          ajax.onreadystatechange = function (){
            if (this.readyState == 4 && this.status == 200) {
              ...
              if(display_cv){
                display_cv.innerHTML =  this.responseText + " OK";
